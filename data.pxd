...
cdef extern from 'edf_data.h':
    ctypedef struct FSAMPLE:
        ...
        int16_t  htype     #head-tracker data type (0=none)   */
    ...
    ctypedef struct FEVENT:
        ...
        uint16_t flags      # error, warning flags*/
        uint16_t input
        uint16_t buttons
        uint16_t parsedby   # 7 bits of flags: PARSEDBY codes*/
    ...
    ctypedef struct RECORDINGS:
        uint32_t time		# start time or end time*/
        ...
        char record_type	# 1 = SAMPLES, 2= EVENTS, 3= SAMPLES and EVENTS*/
        char pupil_type	# 0 = AREA, 1 = DIAMETER*/
        char recording_mode# 0 = PUPIL, 1 = CR */
        char filter_type   # 1,2,3 */	
        char  pos_type		#PARSEDBY_GAZE  PARSEDBY_HREF PARSEDBY_PUPIL*/
