...
# The SAMPLE struct contains data from one 4-msec eye-tracker sample.
# The <flags> field has a bit for each type of data in the sample.
# Fields not read have 0 flag bits, and are set to MISSING_DATA.
